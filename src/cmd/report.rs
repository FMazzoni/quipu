...
//!
//! The synopsis below is fenced deliberately: outside a code block, rustdoc
//! parses `<id>`, `<duration>` and friends as unknown HTML tags and silently
//! deletes them, losing every argument placeholder (QP-96).
//!
//! ```text
//! Modes:
